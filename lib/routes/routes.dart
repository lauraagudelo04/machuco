...
abstract final class AppRoutes {
  ...
  static const clientNotifications = '/notifications/client';
  static const ownerNotifications = '/notifications/owner';
  static const adminNotifications = '/notifications/admin';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    final Widget page = switch (settings.name) {
      ...
      clientNotifications => const ClientNotificationView(),
      ownerNotifications => const OwnerNotificationView(),
      adminNotifications => const SystemAdminNotificationView(),
