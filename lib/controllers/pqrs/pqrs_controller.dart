...
export 'package:machuco/models/pqrs/pqrs_store.dart'
    show pqrsCurrentClientId, pqrsCurrentMotelId;

/// Lifecycle rules of the PQRS module, on top of a [PqrsStore].
///
/// It is a [ChangeNotifier] so the client, owner and system administrator
/// views stay in sync with plain Flutter state management: a widget listens
